<?php namespace App\Http\Controllers;
	...
	class AdminPurchaseOrdersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Suppliers Id","name"=>"suppliers_id","join"=>"suppliers,name"];
			...
			$this->form[] = ['label'=>'Purchase Order #','name'=>'purchase_order_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
