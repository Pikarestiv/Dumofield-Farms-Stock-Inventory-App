<?php namespace App\Http\Controllers;
	...
	class AdminSuppliersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Phone Number","name"=>"phone"];
			...
			$this->form[] = ['label'=>'Phone Number','name'=>'phone','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10','placeholder'=>'You can only enter the number only'];
